function guardar(){
    ...
    fetch("https://softwareseguro.netlify.app/.netlify/functions/guardar", requestOptions)
...
function listar(){
    ...
    fetch("https://softwareseguro.netlify.app/.netlify/functions/obtener/"+ndoc, requestOptions)
      .then((response) =>
        response.text())
      .then((result) =>
        cargar(result))
