function guardar(){
    ...
    fetch("https://otraappp.netlify.app/.netlify/funtions/usuarios/usuarios", requestOptions)
...
function listar(){
    ...
    fetch("https://otraappp.netlify.app/.netlify/funtions/usuarios/usuarios"+ndoc, requestOptions)
      .then((response) =>
        response.text())
      .then((result) =>
        cargar(result))
