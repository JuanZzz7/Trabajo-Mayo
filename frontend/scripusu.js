function guardar(){
    ...
    fetch("https://softwareseguro.netlify.app/.netlify/functions/usuarios.js", requestOptions)
...
function listar(){
    ...
    fetch("https://softwareseguro.netlify.app/.netlify/functions/usuarios.js"+ndoc, requestOptions)
      .then((response) =>
        response.text())
      .then((result) =>
        cargar(result))
