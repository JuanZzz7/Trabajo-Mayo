function guardar(){
    ...
    fetch("https://otraappp.netlify.app/.netlify/funtions/usuarios/usuarios.js", requestOptions)
...
function listar(){
    ...
    fetch("https://otraappp.netlify.app/.netlify/funtions/usuarios/usuarios.js"+ndoc, requestOptions)
      .then((response) =>
        response.text())
      .then((result) =>
        cargar(result))
