function guardar(){
    ...
    fetch("https://softwareseguro.netlify.app/.netlify/functions/usuarios/guardar", requestOptions)
...
function listar(){
    ...
    fetch("https://softwareseguro.netlify.app/.netlify/functions/usuarios/obtener/"+ndoc, requestOptions)
      .then((response) =>
        response.text())
      .then((result) =>
        cargar(result))
