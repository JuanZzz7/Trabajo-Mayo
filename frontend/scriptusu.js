function guardar(){
    ...
    fetch("https://trabajods.netlify.app/.netlify/funtions/usuarios", requestOptions)
...
function listar(){
    ...
    fetch("https://trabajods.netlify.app/.netlify/funtions/usuarios"+ndoc, requestOptions)
      .then((response) =>
        response.text())
      .then((result) =>
        cargar(result))
